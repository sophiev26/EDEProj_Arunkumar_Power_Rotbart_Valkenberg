...
Ak_data <- 
  read.csv(
    '~/Project/EDEProj_Arunkumar_Power_Rotbart_Valkenberg/Data_Overall/Raw/AK_SITETREE.csv')
...
write.csv(Species.wanted, file = '~/Project/EDEProj_Arunkumar_Power_Rotbart_Valkenberg/Data_Overall/Processed/AK_SITETREE_SpeciesWanted.csv', 
          row.names = FALSE)
```

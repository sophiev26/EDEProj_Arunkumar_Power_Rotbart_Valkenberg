...
# Load your datasets
Ak_data <- 
  read.csv('~/EDEProj_Arunkumar_Power_Rotbart_Valkenberg/AK_SITETREE.csv')
```
...
- Conclusions 
Tree species in Alaska vary significantly by height
Diameter best effect, though plot has less of a significant effect

-Summary
Picked topic due to forestry background and interest in a non-Carolina ecosystem
Found data from USFS and wrangled it for four species
Created correlations to find general trends between variables
e.g. black spruce height being less effected vy diameter than other species

Ran anova on each species, all were significant 
Ran tukey LSD because of that, list greatest and least difference
